...
i = 1 & \multicolumn{3}{c|}{} \\ \hline
      ...
      & j = 3  & \hspace{2cm}$v[1] = 4 \geq v[1] = 3$ &\hspace{2cm} $contador = 3$  \\ \hline
      & j = 4  & \hspace{2cm}$v[1] = 4 \geq v[1] = 1$ &\hspace{2cm} $contador = 4$  \\ \hline
...
i = 2 & \multicolumn{3}{c|}{} \\ \hline
      ...
      & j = 3  & \hspace{2cm}$v[2] = 2 \geq v[1] = 3$ &\hspace{2cm} $contador = 1$  \\ \hline
      & j = 4  & \hspace{2cm}$v[2] = 2 \geq v[1] = 1$ &\hspace{2cm} $contador = 2$  \\ \hline
...
i = 3 & \multicolumn{3}{c|}{} \\ \hline
      ...
      & j = 3  & \hspace{2cm}$v[3] = 3 \geq v[1] = 3$ &\hspace{2cm} $contador = 2$  \\ \hline
      & j = 4  & \hspace{2cm}$v[3] = 3 \geq v[1] = 1$ &\hspace{2cm} $contador = 3$  \\ \hline
...
i = 4 & \multicolumn{3}{c|}{} \\ \hline
      ...
      & j = 3  & \hspace{2cm}$v[4] = 1 \geq v[1] = 3$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 4  & \hspace{2cm}$v[4] = 1 \geq v[1] = 1$ &\hspace{2cm} $contador = 1$  \\ \hline
...
\vspace{-1cm}  \begin{codebox}
  ...
  \li   $\proc{broadcast}(v, MESTRE)$  \End
  \li  \For $j = 1$ \To $n-1$ \DoSeq 
  \li  \If $v\_local[i] < v\_local[j]$ \Then 
  \li  $contador = contador + 1$ \End   \End
  \li  \If $id = MESTRE$ \Then
  \li  \For $i = 1$   \To $p-1$ \DoSeq
  \li          $\proc{recebe}(contador, ANY\_SOURCE)$
  \li          $vetor\_ordenado[contador] = v[i]$  \End  
  \li  \Else
  \li          $\proc{envia}(contador, MESTRE)$\End
  \End
\end{codebox}
\end{slide}
