...
i = 1 & \multicolumn{3}{c|}{} \\ \hline
      & j = 1  & \hspace{2cm}$v[1] = 4 > v[1] = 4$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 2  & \hspace{2cm}$v[1] = 4 > v[2] = 2$ &\hspace{2cm} $contador = 1$  \\ \hline
      & j = 3  & \hspace{2cm}$v[1] = 4 > v[3] = 3$ &\hspace{2cm} $contador = 2$  \\ \hline
      & j = 4  & \hspace{2cm}$v[1] = 4 > v[4] = 1$ &\hspace{2cm} $contador = 3$  \\ \hline
...
i = 2 & \multicolumn{3}{c|}{} \\ \hline
      & j = 1  & \hspace{2cm}$v[2] = 2 > v[1] = 4$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 2  & \hspace{2cm}$v[2] = 2 > v[2] = 2$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 3  & \hspace{2cm}$v[2] = 2 > v[3] = 3$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 4  & \hspace{2cm}$v[2] = 2 > v[4] = 1$ &\hspace{2cm} $contador = 1$  \\ \hline
...
i = 3 & \multicolumn{3}{c|}{} \\ \hline
      & j = 1  & \hspace{2cm}$v[3] = 3 > v[1] = 4$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 2  & \hspace{2cm}$v[3] = 3 > v[2] = 2$ &\hspace{2cm} $contador = 1$  \\ \hline
      & j = 3  & \hspace{2cm}$v[3] = 3 > v[3] = 3$ &\hspace{2cm} $contador = 1$  \\ \hline
      & j = 4  & \hspace{2cm}$v[3] = 3 > v[4] = 1$ &\hspace{2cm} $contador = 2$  \\ \hline
...
i = 4 & \multicolumn{3}{c|}{} \\ \hline
      & j = 1  & \hspace{2cm}$v[4] = 1 > v[1] = 4$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 2  & \hspace{2cm}$v[4] = 1 > v[2] = 2$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 3  & \hspace{2cm}$v[4] = 1 > v[3] = 3$ &\hspace{2cm} $contador = 0$  \\ \hline
      & j = 4  & \hspace{2cm}$v[4] = 1 > v[4] = 1$ &\hspace{2cm} $contador = 0$  \\ \hline
...
\vspace{-0.5cm}  \begin{codebox}
  ...
  \li  \>        $vetor\_ordenado[contador] = valor$  \End  
  \li  \Else
