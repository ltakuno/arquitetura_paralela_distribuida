...
\begin{slide}
\stitle{Projeto de algoritmos paralelos}
2 enfoques comuns:

\itemtrig\ Paralelismo de dados: os dados são particionados, cada subconjunto de dados é associado a um processo, cada processo executa 
os mesmos comandos sobre o seu conjunto de dados.

\itemtrig\ Paralelismo de controle: o problema é dividido em tarefas independentes, cada tarefa é associado com um processo, cada processo executa comandos diferentes.
\end{slide}
